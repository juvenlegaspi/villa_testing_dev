...
<div class="container">
    ...
    @if(auth()->user()->is_admin)
        <a href="{{ url('/shipping/vessels/create') }}" class="btn btn-primary mb-3">
            Add Vessel
        </a>
    @endif
                    ...
                    @forelse($vessels as $vessel)
                        <tr>
                            <td>
                                ...
                                @endphp
                                <a href="{{ url('/shipping/vessels/' . $vessel->id) }}" class="fw-bold text-primary text-decoration-none">
                                    {{ $code }}
                                </a>
                            </td>
...
<div class="modal fade" id="editModal">
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 9999">
        <div id="successToast" class="toast align-items-center text-bg-success border-0">
            <div class="d-flex">
                <div class="toast-body">Vessel updated successfully.</div>
