...
<form method="POST" action="/shipping/vessels/{{ $vessel->id }}/logs/{{ $log->id }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="time" name="time_started" class="form-control"
                   value="{{ $log->time_started }}">
        </div>

        <div class="col-md-6 mb-3">
            <label>Time Finished</label>
            <input type="time" name="time_finished" class="form-control"
                   value="{{ $log->time_finished }}">
        </div>

        <div class="col-md-6 mb-3">
            <label>Total Hours</label>
            <input type="number" step="0.01" name="total_hrs" class="form-control"
                   value="{{ $log->total_hrs }}">
        </div>
    ...
    <a href="/shipping/vessels/{{ $vessel->id }}" class="btn btn-secondary">
        Cancel
    </a>
